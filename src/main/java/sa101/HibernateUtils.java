...
public class HibernateUtils {
    ...
    static {
        ...
        pros.put(Environment.URL, "jdbc:sqlserver://localhost:1433;database=sa01;TrustServerCertificate=true;");
        ...
        // cfg.addAnnotatedClass(sa101.entities.Category.class);
        // cfg.addAnnotatedClass(sa101.entities.Product.class);
        cfg.addAnnotatedClass(sa101.entities.Employee.class);
